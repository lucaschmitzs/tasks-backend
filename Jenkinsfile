pipeline {
    ...
    post {
        ...
        unsuccessful {
            emailtext attachLog: true, body: 'See the attached log below', subject: 'Build $BUILD_NUMBER has failed', to: 'lucaschmitz+jenkins@gmail.com'
        }
        fixed {
            emailtext attachLog: true, body: 'See the attached log below', subject: 'Build is fine!', to: 'lucaschmitz+jenkins@gmail.com'
        }        
    }
}
